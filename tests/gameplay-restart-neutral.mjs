...
console.log('gameplay restart neutral passed: held movement waits for neutral, while fresh post-restart movement is accepted immediately and Start-only retry is atomic');
